...
def plot_3_sigma_complete(args, tlio_states: dict, est_states: dict, gt: dict):
    ...
    pos_3d_plotter.add_scatter(tlio_r, "TLIO (Baseline)", color="r")
    pos_3d_plotter.add_scatter(est_r, "DIVE (Proposed)", color="b")

    pos_3d_plotter.fig.savefig("02_dido_random_3d.png", format="png", dpi=600)
