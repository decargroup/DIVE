...
def plot_position(args, states : dict, gt : dict):
    ...
    # ax.scatter(ts, gyro_db[:, 0], label="gyro_x_db")
    # ax.scatter(ts, gyro_db[:, 1], label="gyro_y_db")
    # ax.scatter(ts, gyro_db[:, 2], label="gyro_z_db")
    # ax.scatter(ts, gyro[:, 0], label="gyro_x")
    # ax.scatter(ts, gyro[:, 1], label="gyro_y")
    # ax.scatter(ts, gyro[:, 2], label="gyro_z")

    # ax.scatter(ts, acc_db[:, 0], label="acc_x_db")
    # ax.scatter(ts, acc_db[:, 1], label="acc_y_db")
    # ax.scatter(ts, acc_db[:, 2] - scipy.constants.g, label="acc_z_db")
    # ax.scatter(ts, acc[:, 0], label="acc_x")
    # ax.scatter(ts, acc[:, 1], label="acc_y")
    # ax.scatter(ts, acc[:, 2] - scipy.constants.g, label="acc_z")
...
def plot_3_sigma_complete_estimation_data(
    ...
    fig_overall, ax_overall = plt.subplots(2, 3)
