...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tlio_filter_output_name", type=str, default="tlio_stratified_splits.txt.npy"
    )
    parser.add_argument("--ground_truth_output_name", type=str, default="data.hdf5")

    # ------------------ target parameters -----------------
    parser.add_argument("--file_target", type=str, default="eight_a_1.5_v_2.5_rx_1.8_2022-02-22-11-45-31/")
