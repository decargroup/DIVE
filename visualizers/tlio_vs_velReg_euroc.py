...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--tlio_data_list",
        type=str,
        default="/home/angad/learned_quad_inertial/learned_quad_inertial_odometry/network/splits/test_euroc.txt",
    )
    parser.add_argument(
        "--data_list",
        type=str,
    ...
    parser.add_argument(
        "--filter_output_name", type=str, default="velocity_regressor_left_.5_jul11.txt.npy"
    )
