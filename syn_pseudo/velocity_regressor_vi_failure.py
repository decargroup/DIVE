...
def run_filter(args):
    ...
    for i, traj_tuple in enumerate(trajectory_dataloader, 0):
        ...
        for m_seg, gt_seg, ts_seg in zip(measurements, gt_collate, ts_all):
            ...
            r_vec_seg = torch.cat((r_gt[-1].view(1, 3), r_proposed_final.squeeze(2), r_dead_reckoned_final.squeeze(2)), dim=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--filter_output_name", type=str, default="vi_failure_position_6.txt"
    )
