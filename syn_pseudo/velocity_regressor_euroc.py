...
def run_filter(args):
    ...
    trajectories = data_loaders.EuRoCDataset(args=args)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--filter_output_name", type=str, default="velocity_regressor_left_.5_jul11.txt"
    )
    parser.add_argument("--data_list_loc", type=str, default="network/splits/test_euroc.txt")
    parser.add_argument(
        "--model_path",
        type=str,
        default="/home/angad/learned_quad_inertial/learned_quad_inertial_odometry/lightning_logs/validation_checkpoints/velVecReg_strat_july11_.5_best_val_loss.ckpt", # "/home/angad/learned_quad_inertial/learned_quad_inertial_odometry/lightning_logs/validation_checkpoints/velVecReg_aug_gt_30_1s_moreData_best_val_loss.ckpt",
    ) 
    ...
    parser.add_argument("--sigma_bias_acc", type=float, default=1e-4)
