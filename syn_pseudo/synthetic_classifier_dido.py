            ...
            if torch.any(quadrotor_model.marker):
                log_vec_k = torch.cat(
                    (
                        ...
                        t_k.view(1, 1, 1),
                        quadrotor_model.marker.reshape(1, 4, 1),
                        omega,
                        acc,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_list", type=str, default="validation_list_short.txt")
    parser.add_argument("--filter_output_name", type=str, default="syn_pseudo_left_raw.txt")
